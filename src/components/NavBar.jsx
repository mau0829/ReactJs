    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192b] text-gray-300'>
        ...
        <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
            <ul>
                ...
                <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-500 bg-[#98adc4]'>
                    <a href="/" className=' flex justify-between items-center w-full text-gray-300 '>
